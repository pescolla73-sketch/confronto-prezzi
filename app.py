...
st.caption("Questa versione finale risolve tutti i problemi di lettura e abbinamento.")
...
if file_mio and file_fornitore:
    try:
        ...
        with st.spinner("Confronto in corso..."):
            ...
            # CORRECTED column names for the supplier file
            cols_fornitore = {
                'Order Id': 'Numero Ordine',
                'Net Local Market Price': 'Prezzo_Base_Fornitore',
                "Supplier's Price": 'Prezzo_Netto_Fornitore' # Corrected: No trailing space
            }
